...
INSERT INTO `products` VALUES ('BG021', 'Túi xách Tommy Hilfiger_02', 'Tommy Hilfiger_02.jpg', 1987000, 1, 1, 'Mỹ', 'Tommy', 'Túi gồm 1 ngăn lớn và nhiều ngăn nhỏ bên trong,Túi dạng đeo chéo. Logo thương hiệu trước túi, trang trí cách điệu', 'Da thật', '2018-04-10', 4);
...
INSERT INTO `products` VALUES ('BG026', 'Túi xách nữ Michael Kors – TXN5501', 'Kors.jpg', 2070000, 0, 1, 'Mỹ', 'Michael Kors', ' Đối với những quý cô chuộng mốt, ưa thích sự thay đổi và không muốn chịu sự chi phối của trào lưu, các mẫu túi xách nữ Michael Kors chế tác thủ công chính là một lựa chọn hoàn hảo để đáp ứng nhu cầu làm mới phong cách mỗi ngày.', 'Da thật', '2018-04-02', 7);
...
INSERT INTO `products` VALUES ('BL0005', 'BALO ĐINH TÁN THỜI TRANG', 'BLhiKa.jpg', 550000, 1, 0, 'Korea', 'HiKa', 'Trong thế giới thời trang của phái đẹp, chiếc túi luôn chiếm một vị trí quan trọng. Từ những cô nàng bình thường nhất cho tới những ngôi sao hàng đầu, tất cả đều chia sẻ một tình yêu vĩ đại với những chiếc túi', 'Vải dù', '2018-04-30', 7);
